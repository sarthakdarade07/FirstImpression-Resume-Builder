            ...
            {items.map((lang, index) => (
              ...
              >
                ...
                <select
                  ...
                  className="shrink-0 w-32 sm:w-36 px-2.5 py-2 bg-gray-50/70 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-[var(--theme-red-start)] transition-all font-medium text-xs sm:text-sm cursor-pointer"
                >
